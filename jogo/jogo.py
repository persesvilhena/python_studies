...
class Background:
    ...
    #posiciona o texto horizontalmente centralizado
    #pygame_text.rect.centerx = screen_size[0]/2
    #posiciona o texto verticalmente na parte inferior
...
class Game:
    ...
    def __init__( self, size, fullscreen ):
        ...
        pygame.display.set_caption( 'ELIME OS COMPUTADORES (precisa de placa de rede)' )
    ...
    def pontuacao( self ):
        ...
        self.draw_text(screen, "PONTUACAO: " + str(xp), 20, 70, 15)
    ...
    def menu( self ):
        ...
        WIDTH = screen_size[0]
        HEIGHT = screen_size[1]
        self.draw_text(screen, "ELIMINE OS COMPUTADORES", 40, WIDTH/2, (HEIGHT/2)-100)
        self.draw_text(screen, "COM PLACAS DE REDES", 30, WIDTH/2, (HEIGHT/2)-60)
    ...
    def gameover( self ):
        ...
        WIDTH = screen_size[0]
        HEIGHT = screen_size[1]
        self.draw_text(screen, "GAMEOVER", 40, WIDTH/2, (HEIGHT/2)-100)
        self.draw_text(screen, "COM PLACAS DE REDES", 30, WIDTH/2, (HEIGHT/2)-60)
        self.draw_text(screen, "Pressione enter para comecar:", 30, WIDTH/2, (HEIGHT/2)-30)
        #draw_text(screen, "or [Q] To Quit", 30, WIDTH/2, (HEIGHT/2)+40)
